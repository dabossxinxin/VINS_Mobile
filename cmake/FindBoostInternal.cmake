...
IF(_WIN_)
    ...
    ENDIF()
ELSEIF(_OSX_)
    FIND_PATH(Boost_INCLUDE_DIR NAMES boost HINTS "${THIRD_PARTY_PATH}/boost/include")
    FIND_PATH(Boost_LIB_DIR NAMES libboost_chrono.a HINTS "${THIRD_PARTY_PATH}/boost/lib")

    SET(Boost_CONTAINER_LIB ${Boost_LIB_DIR}/libboost_container.a)
    SET(Boost_CHRONO_LIB ${Boost_LIB_DIR}/libboost_chrono.a)
    SET(Boost_DATE_TIME_LIB ${Boost_LIB_DIR}/libboost_date_time.a)
    SET(Boost_SYSTEM_LIB ${Boost_LIB_DIR}/libboost_system.a)
    SET(Boost_THREAD_LIB ${Boost_LIB_DIR}/libboost_thread.a)
ENDIF()
